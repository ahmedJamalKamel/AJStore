              ...
              children: [
                ...
                !OrderGetXController.to.loadingOrder.value &&
                    ...
                    ? Expanded(
                        ...
                        itemCount:
                            OrderGetXController.to.listOrder.value.length,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(OrderGetXController
                                            .to.listOrder.value[index].date),
                                        Spacer(),
                                        Container(
                                          height: 34.h,
                                          width: 70.w,
                                          ...
                                          child: Center(
                                              child: Text(
                                            OrderGetXController.to.listOrder
                                                .value[index].status,
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 12.sp),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text("Order Products Count:" +
                                            OrderGetXController.to.listOrder
                                                .value[index].orderProductsCount.toString()),
                                        Spacer(),
                                        Center(
                                          child: Text(
                                            "Total Price :" +
